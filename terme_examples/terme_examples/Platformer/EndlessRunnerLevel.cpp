...
namespace Platformer
{
    void EndlessRunnerLevel::OnPostGameOverDelayEnded()
    {
        ...
        terme::AudioManager::Instance().PlayFx("Resources/Sounds/Platform/ShowEndScreen.wav");
    }
    ...
    void EndlessRunnerLevel::OnGameOver()
    {
        ...
        terme::AudioManager::Instance().PlayFx("Resources/Sounds/Platform/GameOver.wav");
    }
